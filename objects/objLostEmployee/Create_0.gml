...
message[4] = "I was originally not scheduled at this time, but I figured I should stop by to tell you some important information!";
message[5] = "You see, I used to do night shifts like you, but after a single night I stopped.";
...
message[12] = "Things happen nearly every hour here. I think the last night shift employee, left a notebook somewhere around here. Before he ya know...went missing.";
message[13] = "I'm not picking on you! I'm trying to help you out!";
message[14] = "Go find that notebook I'll man the cash register for ya. Please hurryT If you don't find the book then you're a gonner."
message[15] = "";
