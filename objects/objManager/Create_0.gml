...
message[4] = "Of course it matters, silly! You're a new member of the HappyMart family!~ We care for all of our employees, like it's a biiig family!";
...
message[9] = "Your nights will mainly be staying by the cash register, lookin' cute. Hehe.";
...
message[19] = "On the corkboard, there will be an important task! If you get that done by the end of your shift, I'll reward you with some under the table cash!"
